    ...
    if (uploadedBy.value.length > 0){
        ...
        uploadTask.on('state_changed', (snapshot) => {
            ...
            progress.setAttribute('style',  `width: ${progress.ariaValueNow}%`);        
                ...
                $('#upload').append('<div class="form_failure"><div class="form_failure_message"><p style="color: "> Oh no! Something went wrong! Abandon ship! </p></div><input type="button" value="Dismiss" class="dismiss primary button"/></div>');
